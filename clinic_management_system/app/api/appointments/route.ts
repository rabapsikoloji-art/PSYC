...
import { 
  ...
  createInPersonAppointmentWhatsAppMessage
} from "@/lib/meet-utils";
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (userRole === "PSYCHOLOGIST" && !clientId) {
...
export async function POST(req: NextRequest) {
  try {
    ...
    // WhatsApp mesajı için link oluştur (hem online hem yüz yüze randevular için)
    if (appointment.client.phone) {
      ...
      if (isOnline && meetLink) {
        // Online randevu mesajı
        whatsappMessage = createAppointmentWhatsAppMessage(
          clientName,
          appointmentDateTime,
          personnelName,
          meetLink
        ...
        // Yüz yüze randevu mesajı
        whatsappMessage = createInPersonAppointmentWhatsAppMessage(
          clientName,
          appointmentDateTime,
          personnelName
        );
