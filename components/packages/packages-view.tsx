                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSelectedPackage({
                        ...selectedPackage,
                        totalSessions: e.target.value === "" ? 0 : parseInt(e.target.value),
                      })
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSelectedPackage({
                        ...selectedPackage,
                        totalPrice: e.target.value === "" ? 0 : parseFloat(e.target.value),
                      })
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSelectedPackage({
                        ...selectedPackage,
                        discountPercent: e.target.value === "" ? 0 : parseFloat(e.target.value),
                      })
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSelectedPackage({
                        ...selectedPackage,
                        validityDays: e.target.value === "" ? 0 : parseInt(e.target.value),
                      })
                    }
                  />
                </div>
