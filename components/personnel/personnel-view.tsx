  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(error.error || 'Personel silinemedi!');
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <PersonnelDialog onSuccess={handleCloseDialog} />
        </div>
      </div>
      ...
      <AlertDialog open={!!deletingPersonnel} onOpenChange={() => setDeletingPersonnel(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {deletingPersonnel && `${deletingPersonnel.firstName} ${deletingPersonnel.lastName} personelini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.`}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
